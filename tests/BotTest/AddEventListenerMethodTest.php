...
class AddEventListenerMethodTest extends PHPUnit_Framework_TestCase{
    ...
    function testAddEventListener(){
        $ret = $this->bot->run();
        $rt = '{"version":"2.0","context":{},"session":{"attributes":{}},"response":{"directives":[],"shouldEndSession":true,"card":null,"resource":null,"outputSpeech":{"type":"PlainText","text":"这是一个测试回复，表面bot已经收到了端上返回的AudioPlayer.PlaybackStarted event"},"reprompt":null}}';
